      ...
      <div class="grid_8">
		<?php
			...
			`	$id = $_GET['idd'];
				...
				$query="select * from request where requestid='$id' and idclient='".$_SESSION['idcli']."'";
				...
				if (mysql_num_rows($result)!= 0)
				{
					...
					if ($dateEx[5]==0)
						$monthcomplete = substr($dateEx,6,1);
					else
						$monthcomplete = substr($dateEx,5,2);			

					echo "<p>";
					echo "<strong>List of previous requests of ".$nameclient."</strong><br/>";
					echo "Request perform the : " . $date . " " . $month[$monthcomplete] . " " . $year . "<br/>";
					echo "Visits requested :<br/>";
					echo "<br/>";
					echo "</p>";
					
					$query="select b.housename, b.houseprice, b.housephoto from house b, visiter v where v.requestid='$id' and b.houseid=v.houseid";
					$result = mysql_query($query);
					if (mysql_num_rows($result)!= 0)
					{
						echo "
						...
						while($row = mysql_fetch_array($result))
						{
							...
							echo "<td>".$row["houseprice"]."</td>";
							echo "<td><img src='img/".$row["housephoto"]."' width='120px'></td>";
							echo "</tr>";
						}
						echo "</table>";
					}
