		...
		<?php
			...
			if($_SESSION['nbVisitesX'] != 0)
			{
				...
				while($i < $_SESSION['nbVisitesX'])
				{
					...
					$requete = "select b.houseid , b.houseprice, b.houseadr from bien b where b.houseid = '$var' ;";
				...
				{	
					...
					$Requestquery = 'insert into request (daterequest,availability,idclient)
					...
					while($i<$_SESSION['nbVisitesX'])
					{
						...
						$requeteVisite = "insert into visiter (houseid,requestid,priority) 
